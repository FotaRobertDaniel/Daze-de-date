...
<div class="table-buttons">
    <form class="searchForm" id="searchForm" method="post">
            <label for="nume_eveniment_cautare">Nume:</label>
            <input type="text" name="nume_eveniment_cautare" id="nume_eveniment_cautare">

            <label for="categoriievenimente_cautare">Categoeiievenimente:</label>
            <select name="categoriievenimente_cautare"></select>
        ...
        $(document).ready(function() {
            $.ajax({
                ...
                success: function(response) {
                    $('select[name="categoriievenimente_cautare"]').html(response);
                }
            });
        });
